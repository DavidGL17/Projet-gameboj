...
public class Cpu implements Component, Clocked {
    ...
    // Inherited cycle method from Clocked and its auxiliary method
...
=======
		...
		/**
		 * Operates the action corresponding to the opcode and updates nextNonIdleCycle accordingly
		 * @param opcode - the opcode
		 * @param cycle - the cycle being execued
		 */
	    private void dispatch(Opcode opcode, long cycle) {
	        ...
	        case CPL: {
	        	Regs.set(Reg.A,Bits.complement8(Regs.get(Reg.A)));
	        	combineAluFlags(0,FlagSrc.CPU,FlagSrc.V1,FlagSrc.V1,FlagSrc.CPU);
>>>>>>> 89e722c123a2424be708b5eb4f85535add576b60
