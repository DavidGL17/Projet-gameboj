...
=======
    public static class Builder {
    		...
    		/**
    		 * Builds a Builder 
    		 * @param size the number of Bit of the desired BitVector
    		 */
    		...
    		private int[] buildIntTable() {
    			...
    			for (int rank=0 ; rank<res.length; rank++) {
    				res[rank]= table[rank*4] + (table[rank*4+1] +(table[rank*4+2] + (table[rank*4+3] <<8) <<8 )<<8) ;
    			}
    			return res;
    		}
...
>>>>>>> bb21ad8884bee23a78b45f4e4d4b3fe87ffda2a3
}
